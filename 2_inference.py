...
while time_difference_in_hour >= 1:
    ...
    # To use a different model, comment out the active model and uncomment the desired one.
    ...
    if not jump:
        ...
        cuda_provider_options = {'device_id': '2', 'arena_extend_strategy':'kSameAsRequested',}
